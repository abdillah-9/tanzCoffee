  ...
  return (
    <NavStates.Provider value={{activeLink, setActiveLink}}>
      <div style={Main}>
        ...
        <div style={{minHeight:'60px', width:'100vw', backgroundColor:'rgba(28, 28, 59, 1)', display:'flex', justifyContent:'center', alignItems:'center', padding:'15px', textAlign:'cente'}}>
